        ...
        r = {
            ...
            6: [function(e, t, n) {
                function o(e) {
                    ...
                    e.readDoubleLE = m ? b : k,
                    e.readDoubleBE = m ? k : b) : (e.writeDoubleLE = v.bind(null, r, 0, 4),
...
function  xl(val){
    return PolicyInfoByTypeIdParam$encode(val)['finish']()['slice']()
}

// console.log(PolicyInfoByTypeIdParam$encode(data)['finish']()['slice']());

// 建议   Writer.create() 可以做混淆   可以做僵尸代码
