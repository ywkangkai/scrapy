...
-- 自关联
	...
	-- 查询出山东省有哪些市
	select * from areas as province inner join tb_areas as city on city.pid=province.aid having province.atitle="山东省";
	select province.atitle, city.atitle from tb_areas as province inner join tb_areas as city on city.pid=province.aid having province.atitle="山东省";

	-- 查询出青岛市有哪些县城
	select province.atitle, city.atitle from tb_areas as province inner join tb_areas as city on city.pid=province.aid having province.atitle="青岛市";
	select * from tb_areas where pid=(select aid from tb_areas where atitle="青岛市");
